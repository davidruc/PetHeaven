...
], Afiliacion.prototype, "id_afiliacion", void 0);
__decorate([
    IsDefined(),
    ...
    Transform(({ value }) => { if (/^[a-z A-Z áéíóúÁÉÍÓÚñÑüÜ]+$/.test(value))
        ...
        throw { status: 400, message: `El dato del plan usuario incumple los parametros acordados` }; }, { toClassOnly: true }),
    __metadata("design:type", String)
], Afiliacion.prototype, "plan_usuario", void 0);
