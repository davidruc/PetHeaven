...
Se generaró una base de datos que contiene usuarios, información de la mascota, tipo de afiliación e información de la entrega de la mascota. A continuación se encuentra el Diagrama de la base de datos final:

 ![DiagramaBaseDeDatos](./img/diagramaBaseDeDatos.png)

Se realizaron un par de modificaciones en el transcurso de producción del proyecto con el objetivo de adecuar mejor la lógica de la base de datos.
